...
file_in <- './tcr_vdj/publication/treated_tcr.fancyvj.wt.txt'
file_out <- './tcr_vdj/publication/treated_tcr.pdf'
...
mat <- mat[as.vector(rowSums(mat) > 1), as.vector(colSums(mat) > 1)]
dim(mat)
